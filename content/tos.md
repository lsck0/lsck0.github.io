...
- Use content from this site to fine-tune, train, or evaluate language models
- Reproduce content from this site in AI-generated outputs without proper attribution and linking
...
When reusing content under the MIT License, include attribution to the original author (Luca Sandrock) and a link to the source page.

## 4. Non-AI Scraping

Non-AI scraping is permitted for:

- Search engine indexing (Google, Bing, DuckDuckGo, etc.)
- Academic citation and research
- Web archiving (e.g., Wayback Machine)
- Personal use and offline reading
...
For licensing inquiries or to report violations, contact the site owner via the methods listed on the [about page](/about).
